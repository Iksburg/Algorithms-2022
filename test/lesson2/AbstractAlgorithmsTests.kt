...
Но вреден север для меня
        ...
        assertEquals(
            "Пусть всегда будет ",
            longestCommonSubstring("Пусть всегда будет солнце", "Пусть всегда будет небо")
        )
        assertEquals("", longestCommonSubstring("", "Свобода"))
        assertEquals("", longestCommonSubstring("ДОм", "Кот"))
    }
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(4, lesson2.calcPrimesNumber(7))
        assertEquals(25, lesson2.calcPrimesNumber(100))
    }
}